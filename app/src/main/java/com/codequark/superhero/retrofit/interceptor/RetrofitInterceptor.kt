package com.codequark.superhero.retrofit.interceptor

import androidx.annotation.NonNull
import com.codequark.superhero.managers.WriteManager
import com.codequark.superhero.utils.BaseUtils
import com.codequark.superhero.utils.LogUtils
import com.codequark.superhero.utils.RequestUtils
import okhttp3.*
import okio.Buffer
...
class RetrofitInterceptor(
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        val startTimeNsStr = BaseUtils.getDateTimeFormatted(startTimeNs)
        val endTimeNsStr = BaseUtils.getDateTimeFormatted(endTimeNs)
